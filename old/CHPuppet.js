...
function CHSnipe() {
  ...
  let scrape = async function login() {
    ...
    await page.goto('https://www.opskins.com', {
      timeout: 0
    });
  ...
  //  await page.waitForNavigation();
    ...
    await page.goto('https://opskins.com/?app=730_2&loc=shop_search&search_item=%28Case+Hardened%29%7C%28Karambit+Fade%29%7C%28%22M9+Bayonet+%7C+Fade%22%29%7C%28%22Bayonet+%7C+Marble+Fade%22%29%7C%28%22Flip+Knife+%7C+Marble+Fade%22%29+-gloves&sort=n', {
      timeout: 0
    });
